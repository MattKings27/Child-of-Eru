...
public class CriarHero extends Personagem {

    public CriarHero(String nome, int forca, int destreza, int constituicao, int inteligencia, int sabedoria, int carisma, String classe) {
        super(nome, forca, destreza, constituicao, inteligencia, sabedoria, carisma, classe);
    }

    // adicionar texto como RPG (teste)
    public static void textoRPG(String texto) {
        ...
        for (int i = 0; i < texto.length(); i++) {
            ...
            try {
                Thread.sleep(200); // pausa por 50 milissegundos entre cada letra
